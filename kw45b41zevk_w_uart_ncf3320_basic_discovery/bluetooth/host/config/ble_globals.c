...
#define gL2caLeCbChannelEntrySize_c      (48U)
...
extern uint16_t mActiveServiceChangedCharHandle[gBleAppMaxActiveConnectionsGattCaching_c];
...
extern uint16_t gGattActiveClientSupportedFeaturesHandles[gBleAppMaxActiveConnectionsGattCaching_c];
...
extern const bool_t gUseCSLibHook;
const bool_t gUseCSLibHook = gUseCSLibHook_c;
